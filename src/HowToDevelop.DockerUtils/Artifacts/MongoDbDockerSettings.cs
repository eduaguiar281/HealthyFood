...
namespace HowToDevelop.DockerUtils.Artifacts
{
    public class MongoDbDockerSettings : IDockerSettings
    {
        ...
        public static MongoDbDockerSettings Default =>
            new MongoDbDockerSettings(DefaultImageName, DefaultImageTag, DefaultContainerPrefix);
        ...
        public MongoDbDockerSettings(string dockerImageName, string dockerImageTag, string dockerContainerPrefix)
            :this(null, null, null, dockerImageName, dockerImageTag, dockerContainerPrefix, null, null, null)
        {
            
        }

        public MongoDbDockerSettings(string hostName, string mongoUser, string mongoPassword, 
            string dockerImageName, string dockerImageTag, string dockerContainerPrefix, 
            string databaseName, int? waitUltil, int? port)
        {
            ...
            WaitUntil = waitUltil ?? DefaultTimeWaitUntilDatabaseStartedInSeconds;
